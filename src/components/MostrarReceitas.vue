<script lang="ts">
import { itensDeLista1EstaoEmLista2 } from '@/operações/listas';
...
export default {
  ...
  data() {
    ...
    async created() {
        const receita = await obterReceitas();

        this.receitasEncontradas = receita.filter((receita) => {
          // Lógica que verifica se a receita pode ser feita:
          // Todos os ingredientes de uma receita devem ser inclusos na minha linha de ingredientes
...
<template>
    <section class="mostrar-receitas">
        ...
        <div class="receitas-nao-encontradas">
            <p class="paragrafo-lg receitas-nao-encontradas__info">
                Ops, não encontramos resultados para sua combinação. Vamos tentar de novo?
            </p>

            <img src="/src/assets/sem-receitas.png"
